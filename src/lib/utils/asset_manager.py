...
class AssetManager:
    ...
    @staticmethod
    def get_asset_path(asset_type: AssetType, filename: Optional[str] = None, absolute: bool = False) -> Union[Path, str]:
        """
    ...
    @staticmethod
    def get_data(asset_type: AssetType, filename: str, absolute: bool = False) -> Union[Path, str]:
        """Get the path to a data asset."""
        return AssetManager.get_asset_path(asset_type, filename, absolute)
    
    @staticmethod
    def get_img(filename: str, subfolder: Optional[str] = None, absolute: bool = False) -> Union[Path, str]:
