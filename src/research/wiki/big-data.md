# [Big Data](https://www.kaggle.com/datasets/timoboz/data-science-cheat-sheets)
...
The name ‘Big Data’ itself is related to a size which is enormous. Is a huge
amount of data.
...
- To determine the value of data, size of data plays a very crucial role. If the
  ...
  This means whether a particular data can actually be considered as a Big Data
  or not, is dependent upon the volume of data.
- Hence while dealing with Big Data it is necessary to consider a characteristic
  ‘Volume’.
- _Example:_ In the year 2016, the estimated global mobile traffic was 6.2
...
- _Example:_ There are more than 3.5 billion searches per day are made on
...
- Variety is basically the arrival of data from new sources that are both inside
  ...
  - **Semi- Structured data**: This data is basically a semi-organised data. It
  ...
  - **Unstructured data**: This data basically refers to unorganized data. It
    ...
    etc. are the examples of unstructured data which can’t be stored in the form
    of rows and columns.
...
- _Example:_ Data in bulk could create confusion whereas less amount of data
